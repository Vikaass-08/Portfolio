export const EduData = [
  {
    ...
    extra: ["Electronics and Telecommunications", "CGPA: 8.96"],
    id: "EducFirst",
  },
  {
...
export const ExpData = [
  {
    ...
    subHeading: "SDE 2",
    extra: [
      "Worked on the backend side of the things to enhance the performance and the response time.",
      "Designed and architected an higly customisable and configurable filtering system.",
      "Tech stack: NodeJs,Java Springboot,docker,GCP",
    ],
    id: "plumhq",
  },
  {
    date: "June 2022 - Feb 2025",
    heading: "Juspay",
    subHeading: "SDE",
    extra: [
